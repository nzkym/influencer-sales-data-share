...
결과 시트 (쿠팡 로켓 인센티브)
  ├─ '쿠팡 로켓 입고내역' 탭: 년월 / SKU명 / 입고수량 (수량 합계, 년월 최신순)
  └─ '쿠팡 로켓배송' 탭:     년월 / 입고금액(총단가,단위:원) / 직전3개월평균대비 증감금액 / 직전 3개월평균 / 인센티브예상금액
```
...
### '쿠팡 로켓배송' 탭의 인센티브 계산 (C~E열)

- D(직전 3개월평균) = 해당월 기준 직전 3개월 입고금액(B열)의 평균
- C(증감금액) = 해당월 입고금액(B) - D
- E(인센티브예상금액) = C가 500만원 이상이면 C × 1%, 그 외(0 또는 음수)는 0
